export default function TicTacToeSettings({ onSelectMode, onBack }) {
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-copy-300">Choose your game mode</p>
      </div>
      ...
      <div className="grid w-full gap-6 sm:grid-cols-2">
        ...
        <button
          ...
          className="group flex flex-col gap-4 rounded-2xl border border-panel-700 bg-linear-to-br from-brand-500 to-brand-600 p-8 text-left shadow-[0_16px_48px_rgba(0,0,0,0.35)] transition hover:-translate-y-1 hover:shadow-[0_24px_64px_rgba(124,111,255,0.35)]"
        >
          <div className="text-5xl">👥</div>
          <h2 className="text-2xl font-bold text-white">Multiplayer</h2>
          <p className="text-sm text-gray-200">Play against your friend</p>
